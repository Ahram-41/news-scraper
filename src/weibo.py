...
设置文件储存的路径 
'''
path =  "D:\\MyPythonFiles\\张明杰\\total_content_comments.csv" #总的微博博文与评论的全部信息
path1='D:\\MyPythonFiles\\张明杰\\weibo_content.csv'#存取的是微博博文的信息（不包含评论）
path2='D:\\MyPythonFiles\\张明杰\\weibo_comments.csv' #只保存评论的信息
...
headers = {
    ...
    'Referer':'https://s.weibo.com/weibo?q=%E5%BC%A0%E6%98%8E%E6%9D%B0&typeall=1&suball=1&timescope=custom:2021-10-25:2021-11-18-17&Refer=g',
